                                    ...
                                    <div class="notification-list">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="d-flex text-align-start">
                                                <img class="me-2 rounded-circle" src="{{asset('admin')}}/assets/images/users/avatar-2.jpg" alt="Generic placeholder image" height="32">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="d-flex text-align-start">
                                                <img class="me-2 rounded-circle" src="{{asset('admin')}}/assets/images/users/avatar-5.jpg" alt="Generic placeholder image" height="32">
                                                <div class="flex-grow-1">
                    ...
                    <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{asset('admin')}}/assets/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> 
